...
-- Add a new column with the desired length
ALTER TABLE Virtual_Event_platform.Venue_Event_ticket
ADD COLUMN new_event_description VARCHAR(1255) AFTER event_image;

-- Copy data from the old column to the new one
UPDATE Virtual_Event_platform.Venue_Event_ticket
SET new_event_description = event_description;
...
ALTER TABLE Virtual_Event_platform.Venue_Event_ticket
CHANGE COLUMN new_event_description event_description VARCHAR(1255) AFTER event_image;
...
-- Add a new column with the desired length
ALTER TABLE Virtual_Event_platform.Online_Event
ADD COLUMN new_event_description VARCHAR(1500);
...
-- Rename the new column to the original name
ALTER TABLE Virtual_Event_platform.Online_Event
CHANGE COLUMN new_event_description event_description VARCHAR(1500);
...
-- Add a new column with the desired length
ALTER TABLE Virtual_Event_platform.Online_Event
ADD COLUMN new_event_description VARCHAR(1500) AFTER event_image;
...
-- Rename the new column to the original name
ALTER TABLE Virtual_Event_platform.Online_Event
CHANGE COLUMN new_event_description event_description VARCHAR(1500) AFTER event_image;
...
ADD COLUMN new_event_description VARCHAR(1255) AFTER event_duration;

-- Copy data from the old column to the new one
UPDATE Virtual_Event_platform.OnlineEventTicketBook
SET new_event_description = event_description;
...
-- Rename the new column to the original name
ALTER TABLE Virtual_Event_platform.OnlineEventTicketBook
CHANGE COLUMN new_event_description event_description VARCHAR(1255) AFTER event_duration;
...
-- Copy data from the old column to the new one
UPDATE Virtual_Event_platform.VenueEventTicketBook
SET new_event_description = event_description;
