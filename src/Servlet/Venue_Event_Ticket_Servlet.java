...
public class Venue_Event_Ticket_Servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String event_card_number = request.getParameter("card_number");
            ...
            // Set card details
            ticket.setEventCardNumber(event_card_number);
