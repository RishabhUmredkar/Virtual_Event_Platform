...
<html lang="en" class="h-100"><head></head><body class="d-flex flex-column h-100">
    ...
    <%
        ...
        System.out.println("orderId:555::::" + orderId);
        try {
							...
							<div class="main-card">
								...
								<div class="booking-confirmed-bottom">
									<div class="booking-confirmed-bottom-bg p_30">
										...
										<a href="Venue_invoice.jsp" class="main-btn btn-hover h_50 w-100 mt-5"><i class="fa-solid fa-ticket rotate-icon me-3"></i>View Ticket</a>
									</div>
								</div>
							</div>
						</div>
